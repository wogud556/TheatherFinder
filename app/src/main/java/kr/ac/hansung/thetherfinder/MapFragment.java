        ...
        public void CallJson(){
            try{
                ...
                for(int i=0; i<jsonArray.length();i++){
                    ...
                    Log.d("MapFragment", "Location = " + location + "Lng + " + Lng + "Lat = " + Lat);
